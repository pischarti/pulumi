...
class InspectionVpc(pulumi.ComponentResource):
    def __init__(self, name: str, args: InspectionVpcArgs, opts: pulumi.ResourceOptions = pulumi.ResourceOptions()) -> None:
    ...
    def create_firewall(self):
        ...
        subnet_mappings = list(map(lambda id: aws.networkfirewall.FirewallSubnetMappingArgs(subnet_id=id), subnet_ids))
